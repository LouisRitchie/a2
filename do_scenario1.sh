...
sleep 1
tmux send-keys -t $NAME:0.1 'curl "localhost:17455/?op=write&val=june2018"' C-m
tmux send-keys -t $NAME:0.2 'curl "localhost:17455/?op=read"' C-m
tmux send-keys -t $NAME:0.3 'curl "localhost:17455/?op=read"' C-m
tmux send-keys -t $NAME:0.4 'curl "localhost:17455/?op=read"' C-m
